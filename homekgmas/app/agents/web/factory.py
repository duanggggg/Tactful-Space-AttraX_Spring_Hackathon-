"""Factory helpers for web-mode agents and workspaces."""
...
def build_workspace_profile(
    *,
    ...
    """Build one web workspace profile rooted in the mode-specific workspace tree."""
...
def build_agent_builders(
    *,
    ...
    """Return the web agent builders.

    These currently point to lightweight web placeholders so the path split is
    established before web-specific behavior is implemented.
    """
